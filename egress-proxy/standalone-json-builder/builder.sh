...
# input cluster_name of egress (must be unique and match sidecar envar for cluster_name)
read -p "Input the cluster name of the standalone egress instance: " DATACLUSTERNAME

PWD=$(pwd)

SRC=$PWD/standalone-egress-template-json/
